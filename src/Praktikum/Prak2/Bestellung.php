	...
	protected function processReceivedData():void 
    {
        ...
        if(count($_POST)){
            ...
            if (isset($_POST['mySelect']) && isset($_POST['Adresse'])) {
                ...
                $adress = $this->database->real_escape_string($adress);
                // $ordering_time = $this->database->real_escape_string($ordering_time);
                ...
                foreach ($mySelect as $selectedOption){
                   ...
                   // $theSelect = $this->database->real_escape_string($theSelect);
